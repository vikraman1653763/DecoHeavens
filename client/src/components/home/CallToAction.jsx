    ...
    <div className="relative mx-2 md:mx-auto p-px overflow-hidden">
      <div
        className="
          ...
          px-4 sm:px-8
          py-12 md:py-16
          bg-linear-to-r from-[#F7FFFD] to-[#FFF7F2]
          rounded-[15px]
        "
      >
        {/* 🔄 Rotating Spiral BG (safe on mobile) */}
        <img
        ...
        <div
          className="
            ...
            shadow gap-1 rounded-full text-xs
        ...
        {/* Heading */}
        <h2 className="relative z-10 text-2xl md:text-4xl font-medium mt-3 leading-[1.3] text-slate-700">
          Turn Your Dream Moments Into
          <br />
          <span className="bg-linear-to-r from-primary to-secondary bg-clip-text text-transparent font-yatra">
            Art, Beauty & Lasting Memories
          </span>
        </h2>

        {/* Subtitle */}
        <p className="relative z-10 text-slate-600 mt-3 max-w-2xl text-sm md:text-base">
