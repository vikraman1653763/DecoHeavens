  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto flex flex-wrap flex-col">
        ...
        {/* Tabs / Steps */}
        <div className="flex mx-auto flex-wrap mb-14">
          {steps.map((s, i) => {
            const Icon = s.icon;
...
<div className="w-full flex justify-center mb-10">
  {/* ✅ fixed-size image stage (no layout jump) */}
  <div className="relative w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 aspect-[6/5] overflow-hidden rounded-2xl">
    <AnimatePresence mode="wait" initial={false}>
      ...
      />
        ...
        <div className="flex flex-col text-center w-full">
          ...
          <h3 className="text-2xl font-medium title-font mb-3 text-gray-900">
            {steps[active].title}
          </h3>
