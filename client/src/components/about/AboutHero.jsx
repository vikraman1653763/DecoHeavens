...
const AboutHero = () => {
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <motion.div
        className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 max-w-3xl"
        initial="hidden"
        animate="show"
        variants={{
      ...
      >
        ...
        <motion.h1
          className="text-3xl sm:text-5xl lg:text-6xl font-yatra font-semibold text-primary leading-tight"
          variants={{
        ...
        <motion.p
          className="mt-4 text-slate-600 text-sm sm:text-lg max-w-xl"
          variants={{
            hidden: { opacity: 0, y: 14 },
            show: { opacity: 1, y: 0 },
          }}
