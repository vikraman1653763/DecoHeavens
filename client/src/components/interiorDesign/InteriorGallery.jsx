 ...
 const imageSets = [
...

  {
    ...
    slides: [
      ...
      "https://plus.unsplash.com/premium_photo-1727456097852-cb5e11d18e61?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    <section className="text-gray-600 body-font font-poppins">
      ...
      {isOpen && (
        ...
        >
            ...
            >
              <IoIosClose size={34} color="black" className=" bg-white text-white rounded-full hover:bg-white/80" />
            </button>
          <div
