    ...
    >
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        <div className="flex flex-wrap w-full">
          {/* Left: Steps */}
          <motion.div className="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6" variants={fadeUp}>
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="grow pl-4">
                    ...
                    >
                      <motion.span variants={textV} className="font-medium text-gray-900 font-dance text-2xl">
                        {step.title}
                      </motion.span>
          ...
          <motion.div className="lg:w-3/5 md:w-1/2 md:mt-0 mt-12" variants={fadeUp}>
            <motion.div
            ...
            >
              ...
              <motion.div className="absolute left-4 bottom-4" variants={fadeUp}>
                <motion.div
                  ...
                  variants={fadeUp}
                >
                  <motion.p variants={textV} className="text-xs tracking-wider text-gray-600">
                    {activeStep.label}
                  </motion.p>
            ...
            {/* Dots */}
            <motion.div className="flex items-center justify-center gap-2 mt-5" variants={fadeUp}>
              {steps.map((s, i) => (
                <motion.button
                  key={s.key}
                  type="button"
