...
const ContactMapSection = () => {
  return (
    ...
    bg-linear-to-b 
          from-[#fff7f3] to-transparent
        ">
      <div className="relative max-w-6xl mx-auto">
        <div className=" z-4 overflow-hidden w-full h-64 sm:h-80 md:h-96 rounded-2xl   border border-slate-200 border-b-0 rounded-b-none  bg-transparent">
