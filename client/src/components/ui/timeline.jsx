          ...
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10 ">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 bord w-4 rounded-full bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
              <h3
                className="hidden font-dance md:block text-xl md:pl-20 md:text-4xl font-bold text-secondary ">
                {item.title}
              </h3>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3
                className="md:hidden font-dance block text-2xl mb-4 text-left font-bold text-secondary">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
...
className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t
           from-teal-400 via-purple-500 to-purple-500
           from-[0%] rounded-full"
